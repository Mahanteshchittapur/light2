 ...
 * CLI version: 2.12.0
 *
 * Generated: Tue, 29 Aug 2023 08:03:21 GMT
 */

var APP_com_domain_app_lightning = (function () {
  'use strict';
    ...
    static _template() {
      return {
        ...
        Video: {
          ...
          videoTag: true // This will create an HTML video element
        }
      };
    }

    _init() {
      // Retrieve the video element from the template
      this.videoElement = this.tag("Video").video;

      // Set the video source
      //this.videoElement.src ="aamp://devimages.apple.com/iphone/samples/bipbop/bipbopall.m3u8";
